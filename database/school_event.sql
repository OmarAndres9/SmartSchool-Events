...
SELECT "Codigo_Rol", "Nomb_Rol", "Descrip_Rol"
FROM roles
ORDER BY "Codigo_Rol" DESC;


-- Foreign Keys
ALTER TABLE agenda_escolar ADD CONSTRAINT agenda_escolar_fk_1 FOREIGN KEY ("Codigo_Event") REFERENCES eventos ("Codigo_Event") ON DELETE CASCADE;

ALTER TABLE evento_recursos ADD CONSTRAINT evento_recursos_fk_1 FOREIGN KEY ("Codigo_Event") REFERENCES eventos ("Codigo_Event") ON DELETE CASCADE;
ALTER TABLE evento_recursos ADD CONSTRAINT evento_recursos_fk_2 FOREIGN KEY ("Codigo_Recurs") REFERENCES recurso_logistica ("Codigo_Recurs") ON DELETE CASCADE;

ALTER TABLE notificaciones ADD CONSTRAINT notificaciones_fk_1 FOREIGN KEY ("Codigo_Event") REFERENCES eventos ("Codigo_Event") ON DELETE CASCADE;

ALTER TABLE reportes ADD CONSTRAINT reportes_fk_1 FOREIGN KEY ("Codigo_Usuar") REFERENCES usuario ("Codigo_Usuar") ON DELETE CASCADE;
ALTER TABLE reportes ADD CONSTRAINT reportes_fk_2 FOREIGN KEY ("Codigo_Event") REFERENCES eventos ("Codigo_Event") ON DELETE CASCADE;

ALTER TABLE usuario_roles ADD CONSTRAINT usuario_roles_fk_1 FOREIGN KEY ("Codigo_Usuar") REFERENCES usuario ("Codigo_Usuar") ON DELETE CASCADE;
ALTER TABLE usuario_roles ADD CONSTRAINT usuario_roles_fk_2 FOREIGN KEY ("Codigo_Rol") REFERENCES roles ("Codigo_Rol") ON DELETE CASCADE;
